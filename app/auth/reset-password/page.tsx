  ...
  return (
    <div className="min-h-screen bg-[#0f1724] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-[#0b1220] rounded-2xl p-8 shadow-2xl border border-white/5">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-[#60a5fa]/10 rounded-full flex items-center justify-center mx-auto mb-4 border border-[#60a5fa]/20">
              <Lock className="text-[#60a5fa]" size={32} />
            </div>
          ...
          {success ? (
            <div className="text-center py-8">
              <CheckCircle className="w-16 h-16 text-[#60a5fa] mx-auto mb-4" />
              <h2 className="text-2xl font-bold text-white mb-2">Password Reset Successful</h2>
              <p className="text-[#9aa4b2]">Redirecting to login...</p>
            </div>
          ) : (
            <>
              {error && (
              ...
              <form onSubmit={handleResetPassword} className="space-y-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-4 bg-[#0f1724] border border-transparent focus:border-[#60a5fa]/50 rounded-xl outline-none text-white transition-all"
                    value={password}
