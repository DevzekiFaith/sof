    ...
    <div className="bg-[#181818] p-6 rounded-lg">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-bold text-white flex items-center gap-2">
          <Crown className="w-5 h-5 text-[#1ed760]" />
          Gift Courses
        </h3>
      </div>
      ...
      <div className="space-y-4">
        <div className="p-6 bg-[#282828] rounded-lg text-center">
          <Gift className="w-12 h-12 text-[#1ed760] mx-auto mb-3" />
          ...
          <button className="px-6 py-2 bg-[#1ed760] text-black font-bold rounded-full hover:scale-105 transition-transform">
            Send as Gift
          </button>
        </div>
          ...
          {courses.slice(0, 3).map((course) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <p className="text-sm font-bold text-[#1ed760]">${course.priceUSD}</p>
                <button 
                  onClick={() => handleGiftClick(course)}
                  className="p-2 rounded-full bg-[#1ed760]/20 text-[#1ed760] hover:bg-[#1ed760] hover:text-black transition-colors"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-[#282828] text-white rounded-lg border border-[#333] focus:border-[#1ed760] focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-sm font-bold text-white mb-2">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-[#282828] text-white rounded-lg border border-[#333] focus:border-[#1ed760] focus:outline-none resize-none"
                />
              </div>
              <div className="flex items-center justify-between pt-4 border-t border-[#282828]">
                <p className="text-lg font-bold text-[#1ed760]">${selectedCourse?.priceUSD}</p>
                <button
                  onClick={handleAddToCart}
                  disabled={!recipientEmail}
                  className="px-6 py-2 bg-[#1ed760] text-black font-bold rounded-full hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add to Cart
                </button>
              </div>
