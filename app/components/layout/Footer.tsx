...
export default function Footer() {
  return (
    <footer className="bg-[#0b1220] border-t border-white/5 mt-20 sm:mt-32">
      <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-xl text-[#9aa4b2] max-w-md leading-relaxed mb-8">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a key={social.name} href="#" className="w-10 h-10 rounded-full bg-[#0f1724] flex items-center justify-center text-[#9aa4b2] hover:text-white hover:bg-[#0e1624] transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/privacy" className="text-[#9aa4b2] hover:text-white transition-colors font-medium">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-[#9aa4b2] hover:text-white transition-colors font-medium">Terms of Service</Link></li>
              <li><Link href="/refund" className="text-[#9aa4b2] hover:text-white transition-colors font-medium">Refund Policy</Link></li>
            </ul>
          </div>
        </div>

        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-sm text-[#9aa4b2] font-medium">
            <Copyright />
          </div>
          <div className="flex gap-8 text-sm text-[#9aa4b2] font-semibold">
