...
export default function ModuleDetailPage() {
  ...
  // router is used for programmatic navigation if needed
      ...
      <div className="min-h-screen bg-[#121212]">
        <section className="container mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {!currentUser && (
              <div className="mb-6 p-4 bg-[#60a5fa]/10 border border-[#60a5fa]/20 rounded-xl text-left">
          ...
          <div className="max-w-4xl mx-auto">
            <AnimatedSection>
              ...
              <div className="flex flex-wrap gap-3">
                <span className="flex items-center gap-2 px-3 py-1 bg-[#60a5fa]/10 text-[#60a5fa] rounded-full text-sm font-medium border border-[#60a5fa]/20">
                  ...
                  {courseModule.activities.map((activity: string, index: number) => (
                    <div key={index} className="p-6 bg-[#181818] border border-[#282828] rounded-xl hover:border-[#60a5fa]/50 transition-colors group">
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-[#60a5fa] rounded-full flex items-center justify-center flex-shrink-0 mt-1 shadow-lg shadow-[#60a5fa]/20">
                  ...
                  {courseModule.resources.map((resource: { name: string; url?: string; content?: string }, index: number) => (
                    resource.url ? (
                      <a
                        ...
                        className="p-4 border border-[#282828] bg-[#181818] rounded-xl hover:border-[#60a5fa]/50 transition-all group hover:scale-[1.02] cursor-pointer pointer-events-auto"
                        style={{ pointerEvents: 'auto' }}
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#282828] rounded-lg flex items-center justify-center group-hover:bg-[#60a5fa] transition-colors">
                            <FileText className="text-[#a7a7a7] group-hover:text-black w-5 h-5 transition-colors" />
                          </div>
                          <div className="flex-1">
                            <h4 className="font-semibold text-white group-hover:text-[#60a5fa] transition-colors">{resource.name}</h4>
                            <p className="text-sm text-[#a7a7a7]">Download PDF</p>
                          </div>
                          <Download className="text-[#b3b3b3] group-hover:text-[#60a5fa] w-5 h-5 opacity-0 group-hover:opacity-100 transition-all" />
                        </div>
                      </a>
                    ) : (
                      <details key={index} className="p-4 border border-[#282828] bg-[#181818] rounded-xl hover:border-[#60a5fa]/50 transition-all group cursor-pointer pointer-events-auto" style={{ pointerEvents: 'auto' }}>
                        <summary className="flex items-center gap-3 list-none">
                          ...
                          <span className="text-[#b3b3b3] group-hover:text-[#60a5fa]">+</span>
                        </summary>
